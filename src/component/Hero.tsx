  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden ">
      ...
      <img
        ...
        width={100}
        alt="bisrat"
        className="relative rounded-full h-32 w-32 mx-auto object-cover animate-pulse"
      />
      <div className="z-20">
        <h2 className="text-sm font-bold uppercase text-[#F89600] pb-2 md:tracking-[12px] tracking-[10px] dark:text-[#E76500]">
          Software Devloper
        </h2>
        ...
        <div className=" z-10">
          ...
          <div className=" flex m-0 justify-evenly">
            <a href="#projects" className=" ">
              <button className="heroBtnSmall -mt-5 md:heroBtn">
                Education
              </button>
            </a>
            <a href="#contact">
